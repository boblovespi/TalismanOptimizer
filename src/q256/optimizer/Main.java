...
public class Main
{
	...
	{
		if (hasMastiff && !hasShaman)
			return (damage_base + str / 5) * (1 + str / 100) * (1 + cd / 200);
		else if (hasMastiff && hasShaman)
			return (damage_base + cd + str / 5) * (1 + str / 100) * (1 + cd / 200);
		else
			return (damage_base + str / 5) * (1 + str / 100) * (1 + cd / 100);
	}

	double getDPS(double str, double cd, double atcSpd)
	{
		return (getDamage(str, cd) * (2 + atcSpd * atcSpd_multiplier / 50));
	}
	...
	class Calculator_highestSum extends Calculator
	{
		...
		void optimizeSetUp()
		{
			...
			int minStr = (int) strength_base + 5 * tempReforges[3][2] + 8 * tempReforges[4][2] + 12 * tempReforges[5][2]
					+ tempReforges[1][5] + tempReforges[2][3] + 3 * tempReforges[3][5] + 2 * tempReforges[3][3]
					+ 3 * tempReforges[4][3] + 4 * tempReforges[5][5];

			int maxStr = (int) strength_base + 5 * tempReforges[3][2] + 8 * tempReforges[4][2] + 12 * tempReforges[5][2]
					+ tempReforges[1][5] + tempReforges[2][3] + 3 * tempReforges[3][5] + 2 * tempReforges[3][3]
					+ 3 * tempReforges[4][3] + 4 * tempReforges[5][5] + 4 * tempReforges[0][0] + 5 * tempReforges[1][0]
					+ 7 * tempReforges[2][0];

			int totalStrCd = (int) strength_base + (int) critDmg_base + 4 * tempReforges[0][0] + 5 * tempReforges[1][0]
					+ 7 * tempReforges[2][0] + 10 * tempReforges[3][2] + 16 * tempReforges[4][2]
					+ 24 * tempReforges[5][2] + 3 * tempReforges[1][5] + 6 * tempReforges[2][3] + 4 * tempReforges[3][5]
					+ 9 * tempReforges[3][3] + 13 * tempReforges[4][3] + 13 * tempReforges[5][5];
			...
			while (!exit)
			{
				...
				if (hasMastiff && !hasShaman)
					...
					optimalStr = (int) ((9 * tt + 5 * dd + 400 - Math
							.sqrt(21 * tt * tt + 30 * dd * tt + 6000 * tt + 25 * dd * dd - 2000 * dd + 1120000)) / 12
							/ (1 + statMultiplier) + 0.5);
				else
					optimalStr = (int) (
	...
	{
		Color[] rarityColors = { Color.gray, Color.green, Color.blue, new Color(150, 0, 200), Color.orange,
		...
		void writeStaticText(Graphics2D g2d)
		{
			...
			g2d.drawString(
					"Stats Without Talismans:", (int) (50 * displayScaleFactor), (int) (50 * displayScaleFactor));
			...
			for (int ii = 0; ii < 6; ii++)
			{
				...
				g2d.drawString(rarityNames[ii] + ":", (int) (50 * displayScaleFactor),
						(int) ((300 + ii * 35) * displayScaleFactor));
				g2d.drawString(rarityNames[ii] + ":", (int) (790 * displayScaleFactor),
						(int) ((300 + ii * 35) * displayScaleFactor));
			}
			...
			g2d.drawString("Talisman Optimizer", (width - titleLength) / 2 - (int) (90 * displayScaleFactor),
					(int) (50 * displayScaleFactor));
			g2d.setStroke(new BasicStroke(1 + (int) (displayScaleFactor + 0.5)));
			g2d.drawLine((width - titleLength) / 2 - (int) (90 * displayScaleFactor), (int) (53 * displayScaleFactor),
					(width + titleLength) / 2 - (int) (90 * displayScaleFactor), (int) (53 * displayScaleFactor));
			g2d.setColor(Color.black);
			g2d.setFont(new Font("Serif", Font.PLAIN, (int) (24 * displayScaleFactor)));
			g2d.drawString(" - by q256", (width + titleLength) / 2 - (int) (90 * displayScaleFactor),
					(int) (50 * displayScaleFactor));
			g2d.drawString("v 2.2", width - 30 - (int) (g2d.getFontMetrics().stringWidth("v 2.2") * displayScaleFactor),
					height - 35 - (int) (15 * displayScaleFactor));
			for (int ii = 0; ii < 6; ii++)
			{
				g2d.drawString(reforgeNames[ii],
						(int) ((955 + ii * 100 - g2d.getFontMetrics().stringWidth(reforgeNames[ii]) / 2)
								* displayScaleFactor), (int) (250 * displayScaleFactor));
			}
			g2d.drawString("Best Reforges:", (int) (790 * displayScaleFactor), (int) (200 * displayScaleFactor));
			g2d.drawString("Completion Info:",
					(int) ((525 - g2d.getFontMetrics().stringWidth("Completion Info:") / 2) * displayScaleFactor),
					(int) (200 * displayScaleFactor));
			...
			g2d.drawString(
					"Attack Speed multiplier:", (int) (50 * displayScaleFactor), (int) (605 * displayScaleFactor));
		}
		...
		void createTextFields()
		{
			for (int ii = 0; ii < 12; ii++)
			{
				...
				inputFields[ii]
						.setBounds((int) (230 * displayScaleFactor), (int) ((140 + ii * 35) * displayScaleFactor),
								(int) (40 * displayScaleFactor), (int) (24 * displayScaleFactor));
				if (ii < 10 && ii > 3)
					inputFields[ii].setText("" + numberOfTalismans[ii - 4]);
				inputFields[ii].setFont(new Font("Dialog", Font.PLAIN, (int) (12 * displayScaleFactor)));
				add(inputFields[ii]);
			}
			inputFields[0].setBounds((int) (230 * displayScaleFactor), (int) (70 * displayScaleFactor),
					(int) (40 * displayScaleFactor), (int) (24 * displayScaleFactor));
			inputFields[1].setBounds((int) (230 * displayScaleFactor), (int) (100 * displayScaleFactor),
					(int) (40 * displayScaleFactor), (int) (24 * displayScaleFactor));
			inputFields[2].setBounds((int) (230 * displayScaleFactor), (int) (130 * displayScaleFactor),
					(int) (40 * displayScaleFactor), (int) (24 * displayScaleFactor));
			inputFields[3].setBounds((int) (230 * displayScaleFactor), (int) (160 * displayScaleFactor),
					(int) (40 * displayScaleFactor), (int) (24 * displayScaleFactor));
			inputFields[10].setBounds((int) (65 * displayScaleFactor), (int) (560 * displayScaleFactor),
					(int) (50 * displayScaleFactor), (int) (24 * displayScaleFactor));
			inputFields[11].setBounds((int) (250 * displayScaleFactor), (int) (585 * displayScaleFactor),
					(int) (50 * displayScaleFactor), (int) (24 * displayScaleFactor));
		...
		void createButtons()
		{
			...
			calculation_button.setBounds((int) (400 * displayScaleFactor), (int) (520 * displayScaleFactor),
					(int) (250 * displayScaleFactor), (int) (80 * displayScaleFactor));
		...
		void retrieveInputs()
		{
			for (int ii = 0; ii < 11; ii++)
			{
				...
				{
					if (ii < 4)
						Double.parseDouble(inputFields[ii].getText());
					if (ii >= 4 && ii < 10)
						if (Integer.parseInt(inputFields[ii].getText()) < 0)
							inputFields[ii].setText("0");
					if (ii == 10)
						Double.parseDouble(inputFields[10].getText());
					if (ii == 11)
					{
						if (Double.parseDouble(inputFields[11].getText()) < 0)
							inputFields[11].setText("0.0");
						if (Double.parseDouble(inputFields[11].getText()) > 1)
							inputFields[11].setText("1.0");
					}
		...
		void createCompletionPanel()
		{
			...
			completionInfoPanel.setBounds((int) (400 * displayScaleFactor), (int) (225 * displayScaleFactor),
					(int) (250 * displayScaleFactor), (int) (250 * displayScaleFactor));
		...
		void createLabels()
		{
			for (int ii = 0; ii < 9; ii++)
			{
				...
				if (ii < 5)
					statLabels[ii]
							.setBounds((int) (1155 * displayScaleFactor), (int) ((26 + ii * 30) * displayScaleFactor),
									(int) (90 * displayScaleFactor), (int) (30 * displayScaleFactor));
				else
					statLabels[ii].setBounds((int) (1440 * displayScaleFactor),
							(int) ((26 + (ii - 5) * 30) * displayScaleFactor), (int) (90 * displayScaleFactor),
							(int) (30 * displayScaleFactor));
			...
			for (int ii = 0; ii < 6; ii++)
			{
				for (int jj = 0; jj < 6; jj++)
				{
					...
					reforgeLabels[ii][jj].setBounds((int) ((940 + jj * 100) * displayScaleFactor),
							(int) ((280 + ii * 35) * displayScaleFactor), (int) (60 * displayScaleFactor),
							(int) (30 * displayScaleFactor));
		...
		void createCheckBoxes()
		{
			...
			checkBoxes[0].setBounds((int) (50 * displayScaleFactor), (int) (615 * displayScaleFactor),
					(int) (150 * displayScaleFactor), (int) (20 * displayScaleFactor));
			checkBoxes[1].setBounds((int) (50 * displayScaleFactor), (int) (640 * displayScaleFactor),
					(int) (150 * displayScaleFactor), (int) (20 * displayScaleFactor));
		...
		void updateLabels(int[][] optimalReforges)
		{
			...
			statLabels[4].setText((int) (getDPS((int) (str * (1 + statMultiplier)), (int) (cd * (1 + statMultiplier)),
					(int) (ac * (1 + statMultiplier)))) + "");
	...
	class CompletionInfoPanel extends JPanel
	{
		...
		public void paintComponent(Graphics g)
		{
			...
			{
				g2d.drawString("100% completed",
						(int) (125 * displayScaleFactor) - g2d.getFontMetrics().stringWidth("100% completed") / 2,
						(int) (40 * displayScaleFactor));
				g2d.drawString("Processing Time:",
						(int) (125 * displayScaleFactor) - g2d.getFontMetrics().stringWidth("Processing Time") / 2,
						(int) (90 * displayScaleFactor));
				String time = String.format("%.6f", Math.floor(calculator.totalTime / 1000) / 1000000);
				g2d.drawString(time + " seconds",
						(int) (125 * displayScaleFactor) - g2d.getFontMetrics().stringWidth(time + " seconds") / 2,
						(int) (120 * displayScaleFactor));
			}
		}
	}
	...
	class PreperationPanel extends JPanel
	{
		...
		public PreperationPanel()
		{
			...
			JLabel label1 = new JLabel(
					"<html>Enter how big you want this app to be.<br>Enter a larger number for a larger app.<br>Enter a smaller number for a smaller app.<br>Click \"Apply\" to test it out.<br>Once you are happy with the size of the app<br>click \"Start\" to use the talisman optimizer.");
		...
		void getInputs()
		{
			try
			{
				if (Double.parseDouble(inputField.getText()) < 25)
					inputField.setText("25");
			} catch (NumberFormatException e)
			{
